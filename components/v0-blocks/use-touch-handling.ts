...
export function useTouchHandling() {
  ...
  useEffect(() => {
    ...
    document.addEventListener("gesturestart", preventDefaultTouchAction, {
      passive: false,
    });
    document.addEventListener("gesturechange", preventDefaultTouchAction, {
      passive: false,
    });
    document.addEventListener("gestureend", preventDefaultTouchAction, {
      passive: false,
    });
    ...
    document.addEventListener("touchend", preventDefaultTouchAction, {
      passive: false,
    });
