...
export function AiChatPanel({ onBuildActions, currentBricks }: AiChatPanelProps) {
  ...
  return (
    <div className="absolute right-4 top-4 w-80 h-[500px] bg-black/80 backdrop-blur-sm rounded-lg border border-purple-500/30 flex flex-col">
        ...
        <div className="space-y-4">
          {messages.length === 0 && (
            <div className="text-gray-400 text-sm text-center py-8">
              ...
              <br />
              <span className="text-xs text-gray-500">Try: "Build a red tower" or "Create a colorful house"</span>
            </div>
          )}
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-purple-500/30">
        <div className="flex gap-2">
          <Input
            ...
            disabled={isLoading}
          />
          <Button type="submit" size="icon" disabled={isLoading} className="bg-purple-600 hover:bg-purple-700">
